  ...
  return (
       <div style={{width:'100%', height:'600px', backgroundColor:'grey', display:'flex', justifyContent:'center', alignItems:'center'}}>
           <div className="max-w-md w-4/5 m-auto bg-white m-10">
                  ...
                  <h1 className=" text-3xl md:text-4xl font-bold mt-5">Sign Up</h1>
                  <p className="m-3 font-medium text-zinc-600 text-lg">Enter your information to create an account</p>
                  ...
                  <p className="m-3">Already have a account? <span className="underline underline-offset-1 ">Login</span></p>
